...
final public class Utils {
     ...
     */
    public static IonReader getIONReaderFromUri(String file, RunContext runContext)
        throws IonException, IllegalArgumentException, IOException, IllegalVariableEvaluationException, NullPointerException {
        URI resolvedUri = resolveKestraUri(file, runContext);
